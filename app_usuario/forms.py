...
class SolicitarCuenta(forms.Form):
	...
	num_cel 	= forms.CharField(max_length = 7, widget=forms.TextInput(attrs={'class':'span4'}), validators=[validate_telefono])
	...
	num_casa 	= forms.CharField(max_length = 7, widget=forms.TextInput(attrs={'class':'span4'}), 	validators=[validate_telefono])
